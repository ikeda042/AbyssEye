...
from ..paths import BACKEND_DIR, data_path
from ..roi_extract.roi_module import ROIExtractor
from ..tiff_manager_bulk import crud as tiff_bulk_crud

REALTIME_TIFF_DIR = data_path("realtime_tiff")
REALTIME_DB_DIR = data_path("realtime_databases")
REALTIME_CACHE_DIR = data_path("realtime_cache")
PRIMARY_TIFF_DIR = data_path("tiff_manager_bulk")
PRIMARY_DB_DIR = data_path("databases")
LEGACY_REALTIME_TIFF_DIR = BACKEND_DIR / "realtime_tiff"
...
async def copy_latest_to_primary_locations(
    *,
    ...
    # Scope project folders explicitly so realtime保存時にもtiff_manager_bulk側の
    # プロジェクト分離ルールに完全一致させる。
