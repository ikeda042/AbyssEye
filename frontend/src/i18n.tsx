...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    "top.cards.roiBulk.title": "ROI Extraction (Bulk)",
    ...
    "bulk.breadcrumb": "ROI Extraction (Bulk)",
    "bulk.title": "ROI Extraction (Bulk)",
    "bulk.subtitle": "Upload TIFF folders, list them, and run ROI extraction across every file in the folder.",
    "bulk.uploadCta": "Upload folder",
    "bulk.uploading": "Uploading...",
    "bulk.uploadError": "Failed to upload the folder.",
    ...
    "bulk.iterativeMode": "Iterative extraction",
    "bulk.iterativeHint": "When ON, extraction runs iterative passes (slower, may recover missed ROIs).",
    "bulk.extract": "Extract all",
    "bulk.extracting": "Extracting...",
    "bulk.infer": "Infer",
    "bulk.inferNeedsExtract": "Please run ROI extraction first.",
    "bulk.extractError": "Failed to run bulk ROI extraction.",
    ...
    "bulk.notFoundBody.empty": "Upload a folder that contains TIFF files.",
  ...
  ja: {
    ...
    "top.cards.roiBulk.title": "ROI抽出（バルク）",
    ...
    "bulk.breadcrumb": "ROI抽出（バルク）",
    "bulk.title": "ROI抽出（バルク）",
    "bulk.subtitle": "複数TIFFを含むフォルダをアップロードし、フォルダ単位で一括ROI抽出を実行します。",
    "bulk.uploadCta": "フォルダをアップロード",
    "bulk.uploading": "アップロード中…",
    "bulk.uploadError": "フォルダのアップロードに失敗しました。",
    "bulk.uploadSuccess": "{count} 件のファイルを {folders} に保存しました。",
    "bulk.listError": "フォルダ一覧の取得に失敗しました。",
    "bulk.searchPlaceholder": "フォルダ名で検索",
    "bulk.iterativeMode": "反復抽出",
    "bulk.iterativeHint": "ONで反復抽出を有効化します（処理は遅くなりますが、取りこぼしROIを拾える場合があります）。",
    "bulk.extract": "一括ROI抽出",
    "bulk.extracting": "抽出中…",
    "bulk.extractError": "バルクROI抽出の実行に失敗しました。",
    ...
    "bulk.notFoundBody.empty": "TIFFファイルを含むフォルダをアップロードしてください。",
