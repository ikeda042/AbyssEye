...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    "projects.emptyDesc": "Create a project to keep same-field and multi-field datasets separate.",
  ...
  ja: {
    ...
    "projects.emptyDesc": "同一視野と複数視野を混在させないために、まずプロジェクトを作成してください。",
...
export const I18nProvider = ({ children }: { children: ReactNode }) => {
  ...
  const value = useMemo<I18nContextValue>(
    ...
    [language, toggleLanguage, translateFn],
  );
