...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    "bulk.extractFocusMerged": "Extract merged ROI",
    "bulk.extractMergedSuccess": "Merged ROI updated in {db}.",
    "bulk.infer": "Infer",
  ...
  ja: {
    ...
    "bulk.extract": "ROI抽出",
    "bulk.extracting": "抽出中…",
    "bulk.extractFocusMerged": "マージ画像ROI抽出",
    "bulk.extractMergedSuccess": "{db} にフォーカスマージ画像のROI抽出結果を反映しました。",
